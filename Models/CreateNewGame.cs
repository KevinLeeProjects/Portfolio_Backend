...
namespace Portfolio_Backend.Models
{
    public class CreateNewGame
    {
        ...
        public CreateNewGame(EF_DataContext context, DatabaseHelper databaseHelper)
        {
            _context = context;
            _databaseHelper = databaseHelper;
        }

        public bool AddGame(GameModel model)
        {
            ...
            using (NpgsqlConnection connection = GetDatabaseConnection())
            {
                ...
                string query = "INSERT INTO games(title, route, imgsrc, imgalt, github, skills, desctitle, descriptions, subImages) " +
